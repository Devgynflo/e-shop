  ...
  return (
    <div className="relative  w-full">
      <input
        ...
        className={cn(
          "peer  w-full rounded-md border-2 border-slate-400 bg-white p-4 pt-6 font-light outline-none transition focus:border-slate-400 disabled:cursor-not-allowed disabled:opacity-70",
